...
app = FastAPI(title="act_train_platform", version="1.1.0.4")
...
def page(request: Request, template: str, **context: Any) -> HTMLResponse:
    context.setdefault("version", "v1.1.0.4")
...
@app.delete("/api/focus-regions/{region_id}")
