...
class V2IdentityTests(unittest.TestCase):
    ...
    def test_runtime_version_default_port_and_version_route_are_v2(self) -> None:
        ...
        self.assertRegex(VERSION, r"^V2\.4\.\d+\.\d+$")
        self.assertIn(f"`{VERSION}`", (PROJECT_ROOT / "VERSION.md").read_text(encoding="utf-8"))
        ...
        self.assertEqual(version_route.endpoint(), {"version": VERSION})
